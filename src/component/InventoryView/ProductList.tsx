...
interface ProductListProps {
  products: any[];
  isLoading: boolean;
  onEdit: (product: any) => void; // Nouvelle prop pour envoyer le produit à éditer
}
      ...
      {products.map((product) => (
        ...
        >
          <div className="d-flex align-items-center gap-4">
            ...
            <div>
              <div className="d-flex align-items-center gap-2 mb-1">
                ...
                {product.status === 'En attente de validation' && (
                   <span style={{ ...styles.badge, borderColor: '#ffc107', color: '#856404' }}>Vérification</span>
                )}
              </div>
          ...
          <div className="d-flex align-items-center gap-5">
            ...
            {/* Bouton Éditer - Déclenche onEdit avec les données du produit */}
            <button 
